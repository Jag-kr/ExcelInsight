export const en = {
  ...
  metricsDesc: 'Headline numbers that follow your filters',
  ...
  overviewAriaLabel: 'ExcelInsight overview',
  soundFamiliar: 'Sound familiar?',
  problemHeading: 'Spreadsheets shouldn\'t slow you down',
  problemDesc: 'You have the data. You just need answers — not another afternoon of pivot tables.',
  painPoint1Label: 'Hours wasted',
  painPoint1Desc: 'Manually building charts in Excel takes hours you don\'t have.',
  painPoint2Label: 'Human error',
  painPoint2Desc: 'Copy-paste mistakes corrupt reports before they ever reach stakeholders.',
  painPoint3Label: 'Repeat work',
  painPoint3Desc: 'Every new file means rebuilding the same layouts from scratch.',
  everythingYouNeedBadge: 'Everything you need',
  builtForSpeedBadge: 'Built for speed',
  proofHeading: 'From raw file to full dashboard',
  proofDesc: 'No sign-up. No cloud uploads. No waiting. Your data stays in your browser.',
  statBrowserOnly: 'Browser-only',
  statFilesUploaded: 'Files uploaded to server',
  statTimeToChart: 'Time to first chart',
  statChartTypesGenerated: 'Chart types auto-generated',
  getStartedMinutesBadge: 'Get started in minutes',
  toolsHeading: 'Free Excel & CSV Tools — Chart Makers, Dashboards & Data Insights',
  toolsDesc: 'Make bar graphs, line charts, dashboards and get data insights from Excel & CSV files — all free, all private, all browser-based.',
  noAccountNeededBadge: 'No account needed',
  ctaHeading: 'Your data. Your answers. Instantly.',
  ctaDesc: 'Drop any Excel or CSV file above and watch charts, insights, and dashboards build themselves — in seconds, in your browser.',
  uploadFileFreeCta: 'Upload a file — it\'s free',
  uploadFileFreeAriaLabel: 'Scroll to top to upload your file',
  neverLeavesBrowser: 'Never leaves your browser',
  ...
  demoDashboardDonutTitle: 'Revenue by Region',
